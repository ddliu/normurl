...
class Url {
    public static function normalize($url, $base = null) {
        //remove anchor
        ...
        $url = self::url_to_absolute($base, $url);
        return $url;
    }
     ...
     */
    protected static function url_to_absolute( $baseUrl, $relativeUrl )
    {
     ...
     */
    protected static function url_remove_dot_segments( $path )
    {
     ...
     */
    protected static function split_url( $url, $decode=FALSE)
    {
     ...
     */
    protected static function join_url( $parts, $encode=FALSE)
    {
        if ( $encode )
        {
            if ( isset( $parts['user'] ) )
